...
namespace Practica1.Database
{
    ...
    {
        public readonly ICompositeCalculatorRepository repository;
        public CompositeCalculatorServices(ICompositeCalculatorRepository repo)
        {
            repository = repo;
        }
        ...
        public double Calculate(ICompositeCalculator calculator)
        {
            ...
            return repository.CalculateInterest(calculator);
        }
    }
}
